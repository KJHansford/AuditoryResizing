...
\vspace{10mm}
\begin{center}
Kirralise Hansford$^{1}$, Kirsten McKenzie$^{2}$, Daniel Baker$^{1}$, and Catherine Preston$^{1}$
\vspace{30mm}
...
packagelist <- c('R.matlab','ggpubr','tidyverse','ez','lmerTest','ggplot2','MuMIn', 'emmeans','kableExtra','gridExtra','pwr','reshape2','rstatix','ggpubr')
