...
5. Call the container something sensible (i.e. audioresizing), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/KJHansford/AuditoryResizing.git
This will download the repository to a folder called AuditoryResizing
